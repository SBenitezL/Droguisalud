 ...
 */
final class Version20230425152052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE producto (id INT AUTO_INCREMENT NOT NULL, prov_codigo_id INT NOT NULL, prd_nombre VARCHAR(255) NOT NULL, prd_unidad VARCHAR(255) NOT NULL, prd_precio DOUBLE PRECISION NOT NULL, prd_precio_unitario DOUBLE PRECISION DEFAULT NULL, prd_costo DOUBLE PRECISION NOT NULL, prd_iva DOUBLE PRECISION NOT NULL, prd_cantidad INT NOT NULL, INDEX IDX_A7BB0615842DC79 (prov_codigo_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
